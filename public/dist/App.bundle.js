...
function autocomplete(input, latInput, lngInput) {
	if (!input) return; //Skips function from running if no input on page
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 41.9;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -93.1;

  _axios2.default.get('/api/farms/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    var places = res.data;
    if (!places.length) {
    ...
    var markers = places.map(function (place) {
      var _place$farmLocation$c = _slicedToArray(place.farmLocation.coordinates, 2),
          placeLng = _place$farmLocation$c[0],
          placeLat = _place$farmLocation$c[1];
...
function searchResultsHTML(farms) {
  return farms.map(function (farm) {
    return '\n      <a href="/farm/' + farm.farmSlug + '" class="search__result">\n        <strong>' + farm.farmName + '</strong>\n        <br>' + farm.farmDescription + '\n      </a>\n    ';
  }).join('');
}
...
throw new Error("Module build failed: Error\n    at /home/cabox/workspace/node_modules/webpack/lib/NormalModule.js:141:35\n    at /home/cabox/workspace/node_modules/loader-runner/lib/LoaderRunner.js:364:11\n    at /home/cabox/workspace/node_modules/loader-runner/lib/LoaderRunner.js:230:18\n    at context.callback (/home/cabox/workspace/node_modules/loader-runner/lib/LoaderRunner.js:111:13)\n    at Object.asyncSassJobQueue.push [as callback] (/home/cabox/workspace/node_modules/sass-loader/lib/loader.js:57:13)\n    at Object.<anonymous> (/home/cabox/workspace/node_modules/sass-loader/node_modules/async/dist/async.js:2257:31)\n    at Object.callback (/home/cabox/workspace/node_modules/sass-loader/node_modules/async/dist/async.js:958:16)\n    at options.error (/home/cabox/workspace/node_modules/node-sass/lib/index.js:294:32)");
